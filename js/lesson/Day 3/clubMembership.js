const students = {
    ...
    //console.log(students[student].clubMemberships);
    if(students[student].courses.length>=3 && students[student].hasScholarship==true){
        console.log(`${student} is taking 3 or more courses and Has scolarship`);}
    }
    for(const student in students){
        let course=students[student].courses;
        let grade=students[student].GPA;
        let AttendanceRate=students[student].attendanceRate;
        if(AttendanceRate>=80){
            console.log(`${student}`+` has an attendance rate of 80% or higher`);
        }
        //if (grade>=3.4){
        //console.log(`${student} is taking 3 or more courses and has a GPA of 3.5 or higher`);
